...
<div class="container">
    ...
    <form id="board-form">
        ...
        <div class="row mb-4 justify-content-md-center">
            ...
            <div class="col-sm-8 col-lg-9">
                <input type="text" class="form-control" id="boardUserName" name="boardUserName" value="${board.boardUserName}">
            </div>
        </div>
        <div class="row mb-4 justify-content-md-center">
        ...
        <div class="row mb-5 justify-content-md-center">
            <div class="col-sm-10 d-grid gap-2 d-sm-flex justify-content-sm-end">
                <button type="button" class="btn btn-primary" id="submit-button" onclick="updateBoard()">저장</button>
